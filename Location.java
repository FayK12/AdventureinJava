...
public class Location{
 ...
 public boolean isConnected(Location other){
   // using the information in the world check if this location
 ...
 public Location west(){
   /*try{
     if (this.getRow() <0) {
       //System.out.println(this.getRow() <0);
       System.out.println("You can't escape the world without finishing the mission");  
       return new Location(world, row, col);}
   }catch (ArrayIndexOutOfBoundsException e){
     System.err.println("You CANNOT PASS");
 ...
 public String toString(){
   return world.getRoom(this) + ", ("+row+","+col+")";
 }
