...
public abstract class Player{
 ...
 /** Plays a turn for this player
   * 
   * For computer players, players will have the AI for that player.
   * For human player, query the user for input and then react 
 ...
 /** Adds a thing to the player's list of things
   * 
   * @param t is a thing to add to the player's list of things
   */
 ...
 public void interact(Thing t){
   // allows for some interaction with a thing
 }
